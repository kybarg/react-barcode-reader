...
function (_React$Component) {
  ...
  function BarcodeScanner(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "initScannerDetection", function () {
      _this.firstCharTime = 0;
      _this.stringWriting = '';
      _this.scanButtonCounter = 0;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "scannerDetectionTest", function (s) {
